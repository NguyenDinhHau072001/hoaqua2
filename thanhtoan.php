    ...
    <form class="main" action="" method="POST">
        <div class="payment-left">
            ...
            <div class="payment-info">
                ...
                <input name="name" type="text" placeholder="Họ và tên người nhận" value="<?php echo $get_user['name'] ?>">
            </div>
            <div class="payment-info">
                <p>Địa chỉ <span style="color: red">*</span></p>
                <input name="address" type="text" placeholder="Nhập địa chỉ nhận hàng" value="<?php echo $get_user['address'] ?>">
            </div>
            <div class="payment-info">
                <p>Số điện thoại <span style="color: red">*</span></p>
                <input name="phone" type="text" placeholder="Số điện thoại" value="<?php echo $get_user['phone'] ?>">
            </div>
            <div class="payment-info">
                <p>Địa chỉ Email</p>
