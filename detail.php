...
<div class="content">
    <div class="main" style="margin-top: 0px">
        ...
        <div class="product-txt">
            ...
            <p style="line-height: 24px; color: #353535;"><b><?php echo $result1['product_name']?> </b>chỉ đơn giản là
                một đoạn văn bản giả, được dùng
                vào việc trình bày và dàn trang phục vụ
                cho in ấn. Lorem Ipsum đã được sử dụng như một văn bản chuẩn cho ngành công nghiệp in ấn</p>
            <br>
    ...
    <div class="mota">
        ...
        <br>
        <p><b><?php echo $result1['product_name']?> </b>chỉ đơn giản là một đoạn văn bản giả,
