...
if (isset($_GET['huydh'])) {
    // $order_id = $_GET['huydn'];
    $huydonhang = $order->update_status($_GET['huydh'], 2);
}
if (isset($_GET['danhan'])) {
    // $order_id = $_GET['danhan'];
    $danhanhang = $order->update_status($_GET['danhan'], 3);
}
    ...
    <div class="main">
        <div class="danhmuc">
            ...
            <ul>
                ...
                <li><a href="?dagiao=3">Đã giao</a></li>
                <li><a href="?dahuy=2">Đã hủy</a></li>
            </ul>
        </div>
